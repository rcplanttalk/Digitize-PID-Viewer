...
def draw_title_block(
    ...
    """Draw an ISO 7200-compliant title block anchored to the bottom-right (§15).

    Position is always bottom-right (ISO 7200:2004 standard anchor point).
    The title block is a horizontal strip along the bottom of the canvas::
    ...
    Args:
        ...
        metadata: ISO 7200 metadata dict. The "position" key is ignored;
                  bottom-right anchor is always enforced per ISO standards.
    """
    ...
    # ISO 7200:2004 mandates bottom-right anchor (ignore deprecated "position" key)
    x0 = MARGIN
    x1 = CANVAS_W - MARGIN
    y1 = CANVAS_H - MARGIN
    y0 = y1 - TITLE_BLOCK_H
    ...
    # Left panel: legal owner, client, plant, titles
    cy = y0 + pad
    ...
    # Right panel: document identification and metadata
    ...
    # Disclaimer strip below the title block
